        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                (
                    ...
                    INNER JOIN department d on t.department_id = d.id
                    UNION
                    SELECT 4 AS type, a.id, CONCAT(a.number, a.suffix, ' ', s.name, ', ', a.post_code, ' ', t.name) AS name, CONCAT(a.number, a.suffix, ' ', s.name) AS short_name, a.post_code, 3 AS parent_type, s.town_id AS parent_id, a.coordinates AS geometry FROM address a
